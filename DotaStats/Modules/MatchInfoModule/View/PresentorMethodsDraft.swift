...
func getCellData (indexpath: Int) -> MatchTableViewCellData {
    ...
    case 4...4+numberPlayersInMatch: cellType = .matchPlayerInfo(PlayerList(playerNameLabelText: "Bob", playerRankText: "Immortal", playerKillsText: "9", playerDeathsText: "25", playerAssitsText: "3", playerGoldText: "5,7k", playerImage: UIImage(named: "morphling") ?? UIImage(systemName: "circle")!)) //force unwrap??? поменять кружок в перезенторе нельзя ui?
    case 5+numberPlayersInMatch: cellType = .teamMatchInfo(TeamMatchInfo(teamNameLabelText: "Команда 1", teamWinLabel: winnerLoserArray[indexpath-4-numberPlayersInMatch]))
    case 6+numberPlayersInMatch...5+numberPlayersInMatch*2: cellType = .matchPlayerInfo(PlayerList(playerNameLabelText: "Bob", playerRankText: "Immortal", playerKillsText: "9", playerDeathsText: "25", playerAssitsText: "3", playerGoldText: "5,7k", playerImage: UIImage(named: "morphling") ?? UIImage(systemName: "circle")!)) //force unwrap??? поменять кружок в перезенторе нельзя ui?
