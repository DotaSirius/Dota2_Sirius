...
final class MatchPlayerCell: UITableViewCell {
    ...
    func setUpConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            playerImageView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 8),
            playerImageView.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor),
            ...
            playerGoldLabel.widthAnchor.constraint(equalToConstant: 40),
